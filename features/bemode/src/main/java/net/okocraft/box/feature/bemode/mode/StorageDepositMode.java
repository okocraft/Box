...
public class StorageDepositMode implements BoxItemClickMode {
    ...
    public void onClick(@NotNull Context context) {
        ClickModeRegistry.getStorageMode().processDeposit(context);
    }
    ...
    public @NotNull @Unmodifiable List<Component> createLore(@NotNull BoxItem item, @NotNull Player player) {
