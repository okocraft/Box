...
public final class MenuOpener {
    ...
    private static final SoundBase XMAS_SOUND = SoundBase.builder().sound(SoundEventKeys.BLOCK_NOTE_BLOCK_CHIME).pitch(1.8f).build();
    private static final SoundBase NORMAL_SOUND = SoundBase.builder().sound(SoundEventKeys.ENTITY_EXPERIENCE_ORB_PICKUP).pitch(2.0f).build();
