package net.okocraft.box.feature.begui.internal.command;
...
import net.okocraft.box.feature.begui.internal.menu.CategorySelectorMenu;
...
public class MenuOpenCommand extends AbstractCommand {
    ...
    public MenuOpenCommand() {
        super("begui", "box.command.gui", Set.of());
    }
    ...
    public void onCommand(@NotNull CommandSender sender, @NotNull String[] args) {
        ...
        session.setBoxItemClickMode(ClickModeRegistry.getModes(BoxItemClickMode.GuiType.BE).get(0));
    ...
    public @NotNull Component getHelp() {
        return translatable("box.begui.command-help.command-line", AQUA)
                .append(text(" - ", DARK_GRAY))
                .append(translatable("box.begui.command-help.description", GRAY));
    }
