...
public class OtherUtil {
    ...
    public static void registerPermission(String permName, @Nullable String parentPermName) {
        ...
        if (!optionalPerm.isPresent()) {
            ...
            Optional.ofNullable(parentPermName).flatMap(_parentPermName -> Optional.ofNullable(pm.getPermission(_parentPermName))).ifPresent(parentPerm -> perm.addParent(parentPerm, true));
